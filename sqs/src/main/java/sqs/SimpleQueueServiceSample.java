...
public class SimpleQueueServiceSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Create a new instance of the builder with all defaults (credentials and region) set automatically.
        // For more information, see Creating Service Clients in the AWS SDK for Java Developer Guide.
        //AmazonSQS sqs = AmazonSQSClientBuilder.defaultClient();
    	
    	//jsa.aws.access_key_id=AKIAJ6NFGXM6QI6PCUZA
    	//		jsa.aws.secret_access_key=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
    	///		jsa.s3.bucket=jsa-s3-bucket-ak
    	//		jsa.s3.region=eu-west-2
        
        BasicAWSCredentials awsCreds = new BasicAWSCredentials("AKIAJ6NFGXM6QI6PCUZA", "h9gE");
